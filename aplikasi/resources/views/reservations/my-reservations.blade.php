...
<div class="container">
    ...
    $endDateTime = \Carbon\Carbon::parse($reservation->reservation_date->format('Y-m-d') . ' ' .
    ...
    <div class="reservation-card {{ $cardClass }}">
        ...
        <div
            style="background: linear-gradient(135deg, #f3e7ff 0%, #e9d5ff 100%); border-radius: 10px; padding: 20px; margin: 20px 0; border: 2px solid #d8b4fe;">
            <h4
                style="color: #7c3aed; margin: 0 0 15px 0; font-size: 16px; display: flex; align-items: center; gap: 8px;">
            ...
            <div class="card-details" style="margin-bottom: 0;">
                <div class="detail-item">
                    <div
                        style="background: #9333ea; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold; font-size: 18px;">
                ...
                <div class="detail-item">
                    <div
                        style="background: #3b82f6; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 20px;">
                        ⏱️
                    </div>
                    <div class="detail-content">
                        ...
                        <div class="detail-value" style="color: #3b82f6;">
                            ...
                            @elseif($reservation->waiting_time < 60) <small style="color: #10b981;">({{
                                $reservation->waiting_time }} menit)</small>
                                @else
                                <small style="color: #f59e0b;">({{ floor($reservation->waiting_time / 60) }} jam {{
                                    $reservation->waiting_time % 60 }} menit)</small>
                                @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-item">
                    <div
                        style="background: #10b981; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 20px;">
                        📈
                    </div>
                    <div class="detail-content">
                        ...
                        <div class="detail-value" style="color: #10b981;">
                            ...
                            <small>({{ floor($reservation->turnaround_time / 60) }} jam {{ $reservation->turnaround_time
                                % 60 }} menit)</small>
                            @endif
                        </div>
                    </div>
                ...
                <div class="detail-item">
                    <div
                        style="background: #06b6d4; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 20px;">
                        🚀
                    </div>
                    <div class="detail-content">
                        ...
                        <div class="detail-value" style="color: #06b6d4;">
                            ...
                            <br><small style="color: #666;">{{
                                \Carbon\Carbon::parse($reservation->start_time)->format('d F Y') }}</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                style="margin-top: 15px; padding: 12px; background: white; border-radius: 8px; border-left: 4px solid #7c3aed;">
                <p style="margin: 0; font-size: 13px; color: #666; line-height: 1.6;">
                    <strong style="color: #7c3aed;">💡 Info:</strong> Jadwal telah dioptimalkan menggunakan algoritma
                    FCFS (First Come First Served).
                    Waktu mulai layanan ditentukan berdasarkan urutan pendaftaran untuk memastikan pelayanan yang adil
                    dan efisien.
                </p>
            </div>
        </div>
        ...
        <div class="card-actions">
            ...
            <a href="{{ Storage::url($reservation->request_letter) }}" target="_blank" class="btn btn-secondary">
            ...
            <a href="{{ route('qr.verify', $reservation->id) }}" class="btn btn-primary">
                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @if(in_array($reservation->status, ['pending', 'confirmed']) && !$isCompleted)
